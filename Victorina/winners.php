...
// Получение данных из таблицы win_numbers
$result = $mysqli->query("SELECT * FROM win_numbers");
...
<head>
    ...
    <!-- SEO Meta Tags -->
    <meta name="description" content="Страница результатов викторины">
	...
	<meta property="og:title" content="Результаты"/> <!-- title shown in the actual shared post -->
	<meta property="og:description" content="Страница результатов викторины" /> <!-- description shown in the actual shared post -->
	<meta property="og:image" content="images/ogimage.jpg" /> <!-- image link, make sure it's jpg -->
	<meta property="og:type" content="article" />

    <!-- Website Title -->
    <title>Выигравшие номера</title>
...
<?php else: ?>
    ...
    <header id="header" class="header">
        <h2>Список выигравших номеров</h2>
		<div style="margin-left:30px;">
			...
			<!-- Кнопка для выгрузки данных в CSV -->
			...
			<!-- Кнопка для очистки таблицы win_numbers -->
			<form action="clear_win_numbers.php" method="post" onsubmit="return confirm('Вы уверены, что хотите очистить таблицу?');">
	...
	<div style="background-color:#222;height:70px;">
		...
		<div style="float:right;margin-right:30px;">
			...
			<div style="margin: 10px 0 0 30px;float:right;">
				...
				&nbsp; &nbsp; &nbsp;
				<form method="post" action="manage_prizes.php" style="float:right;">
